              ...
              <TABLE class=flyoutMenu border=0 id="ecmsinfomenu">
                <TBODY>
                  <TR align=middle> 
                    ...
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ListAllInfo.php?showspecial=4&sear=1');" onmouseover="over(this)" onmouseout="out(this)">审核信息</TD>
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('pl/ListAllPl.php');" onmouseover="over(this)" onmouseout="out(this)">管理评论</TD>
					<?php
					}
					?>
                    ...
                    <TD width="60" class="flyoutLink" onclick="window.open('map.php','','width=1250,height=620,scrollbars=auto,resizable=yes,top=190,left=120');" onmouseover="over(this)" onmouseout="out(this)">后台地图</TD>
                  </TR>
                </TBODY>
              </TABLE>
              <TABLE class=flyoutMenu border=0 id="ecmssysmenu" style="display:none">
                <TBODY>
                  <TR align=middle> 
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('ListZt.php');" onmouseover="over(this)" onmouseout="out(this)">管理专题</TD>
					<?php
					}
					?>
					<?php
