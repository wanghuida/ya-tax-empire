...
<body onLoad="initialize();ContextMenu.intializeContextMenu();" bgcolor="#FFCFAD">
	...
	<table border=0 cellspacing=0 cellpadding=0>
			...
			<td class="list">
				<table border=0 cellspacing=0 cellpadding=0>
			<tr>
			<td id="pr76" class="menu1" onclick="chengstate('76')"><a onmouseout=chft(this,0,76) onmouseover=chft(this,1,76) oncontextmenu=ShRM(this,64,76,'',0)>公司介绍</a></td>
		  </tr>
				  <tr id="item76" style="display:none">
			<td class="list">
						</td>
		 </tr>	
				<tr>
			<td id="pr77" class="menu1" onclick="chengstate('77')"><a onmouseout=chft(this,0,77) onmouseover=chft(this,1,77) oncontextmenu=ShRM(this,64,77,'',0)>公司理念</a></td>
		  </tr>
				  <tr id="item77" style="display:none">
			<td class="list">
						</td>
		 </tr>	
				<tr>
			<td id="pr78" class="menu1" onclick="chengstate('78')"><a onmouseout=chft(this,0,78) onmouseover=chft(this,1,78) oncontextmenu=ShRM(this,64,78,'',0)>专家团队</a></td>
		  </tr>
			...
			<td class="list">
				...
				<tr>
			<td id="pr79" class="menu3" onclick="chengstate('79')"><a onmouseout=chft(this,0,79) onmouseover=chft(this,1,79) oncontextmenu=ShRM(this,64,79,'',0)>联系我们</a></td>
		  </tr>
				  <tr id="item79" style="display:none">
			<td class="list1">
						</td>
		 </tr>	
			</table>
