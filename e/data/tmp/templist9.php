...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/mystyle/css/mycss.css">
</head>
<body>
...
<div id="container">
    <div class="bound body">
        ...
        <div class="grid215 left">
            <div class='leftNav block' id='1001'>
                <div class='top' id='1002'></div>

                <div class='content' id='1003'>
                    <div onclick="toPage('/a/hangyedongcha/yejiexinwen')">
                        业界新闻
                    </div>
                    <div onclick="toPage('/a/hangyedongcha/zuixinfagui')">
                        最新法规
                    </div>
                    <div onclick="toPage('/a/hangyedongcha/gongsixinwen')">
                        公司新闻
                    </div>
                    <div onclick="toPage('/a/hangyedongcha/shuiwuwenhua')">
                        税务文化研究
                    </div>
                </div>
