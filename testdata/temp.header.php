<div id="header">
    <div class="bound">
        <a href="[!--news.url--]" id="logo">
            <img title="首页" src="[!--news.url--]skin/default/images/logo_cn.gif">
        </a>
        <div class="topnav">
            <script>
...
<div id="menu">
    <div class="nav">
        <ul>
            ...
            <li is="menuindex">
                <a iblk="财税大课堂" href="[!--news.url--]a/ketang" class="support"><span>财税课堂</span></a>
                ...
                <div class="menuitempanel">
                    <div class="menucontentdiv">
                        ...
                        <div class="support clearfix">
                            <ul class="list last">
                                <li><a href="[!--news.url--]a/ketang/zhushui/" class="topfrx">注册税务师</a></li>
                                <li><a href="[!--news.url--]a/ketang/chongzu" class="topfrx">企业重组培训</a></li>
                                <li><a href="[!--news.url--]a/ketang/yinggaizeng" class="topfrx">营改增专题</a></li>
                                <li><a href="[!--news.url--]a/ketang/gonggao/" class="topfrx">培训公告</a></li>
