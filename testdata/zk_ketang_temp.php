            ...
            <div class="grid550_l left">
                        ...
                        <div class="case">
                            ...
                            <li class="kecheng_index">
                                <div class="kecheng_img">
                                    <a href="<?=$bqsr['titleurl']?>"><img src="<?=$bqr['titlepic']?>"  width="80" height="80" border="0" /></a>
                                    <div class="kecheng_kan"><a href="<?=$bqsr['titleurl']?>">观看</a></div>
                                </div>
                                <div class="kecheng_jieshao">
                                    <div class="kecheng_title"><a href="<?=$bqsr['titleurl']?>"><?=$bqr['title']?></a></div>
                                    <div class="kecheng_intro">
                                        <span><?=esub($bqr['moviesay'],230,'……')?></span>
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </li>
                ...
                <div id="tabContent2">
                    <div class="core-network">
                        ...
                        <span class="kecheng_more">
                            <a href="[!--news.url--]a/ketang/chongzu/">更多</a>
                        </span>
                    </div>
                    <hr />
                    <div class="content">
                ...
                <div id="tabContent3">
                    <div class="core-network">
                        ...
                        <span class="kecheng_more">
                            <a href="[!--news.url--]a/ketang/yinggaizeng/">更多</a>
                        </span>
                    </div>
                    <hr />
                    <div class="content">
                ...
                <div id="tabContent4">
                    <div class="core-network">
                        ...
                        <span class="kecheng_more">
                            <a href="[!--news.url--]a/ketang/gonggao/">更多</a>
                        </span>
                    </div>
                    <hr />
                    <div class="content">
                        ...
                        [e:loop={91,3,0,0}]
                        <li>
                        <strong><a class="content_more" href="<?=$bqsr['titleurl']?>" target=_blank><?=$bqr['title']?></a></strong><br>
                        <span>
