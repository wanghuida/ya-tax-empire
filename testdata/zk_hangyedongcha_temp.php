        ...
        <div class="grid215 left">
            <div class='leftNav' id='1001'>
                ...
                <div class='content' id='1003'>
                    ...
                    <div id="tab2" onclick="setTab(2,4)">
                        最新法规
                    </div>
                    <div id="tab3" onclick="setTab(3,4)">
                        公司新闻
                    </div>
                    <div id="tab4" onclick="setTab(4,4)">
                        税务文化研究
                    </div>
                </div>
            ...
            <div class="grid550_l left">
                <div id="tabContent1">
                    ...
                    <div class="content">
                        ...
                        <div class="case">
                            <ul>
                                <li style="list-style: none">[ecmsinfo]75,5,32,0,0,8,0[/ecmsinfo]
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="content">
                        <a href="/a/hangyedongcha/yejiexinwen" class="expand" id="morenews">更多</a>
                    </div>
                </div>
                <div id="tabContent2" style="display: none;">
                    ...
                    <div class="content">
                        ...
                        <div class="case">
                            <ul>
                                <li style="list-style: none">[ecmsinfo]78,5,32,0,0,8,0[/ecmsinfo]
                                </li>
                            </ul>
                        </div>
                        <div class="clear"></div>
                        <!--content list end-->
                        <div class="content">
                            <a href="/a/hangyedongcha/zuixinfagui" class="expand">更多</a>
                        </div>
                    </div>
                </div>
                <div id="tabContent3" style="display: none;">
                    ...
                    <div class="content">
                        ...
                        <div class="case">
                            <ul>
                                <li style="list-style: none">[ecmsinfo]77,5,32,0,0,8,0[/ecmsinfo]
                                </li>
                            </ul>
                        </div>
                        <div class="clear"></div>
                        <!--content list end-->
                        <div class="content">
                            <a href="/a/hangyedongcha/gongsixinwen" class="expand">更多</a>
                        </div>
                    </div>
                </div>
                <div id="tabContent4" style="display: none;">
                    ...
                    <div class="content">
                        ...
                        <div class="case">
                            <ul>
                                <li style="list-style: none">[ecmsinfo]76,5,32,0,0,8,0[/ecmsinfo]
                                </li>
                            </ul>
                        </div>
                        <div class="clear"></div>
                        <!--content list end-->
                        <div class="content">
                            <a href="/a/hangyedongcha/shuiwuwenhua" class="expand">更多</a>
                        </div>
                    </div>
                </div>
            </div>
