...
{
	$list_html = str_replace("/home/xuefer/htdocs/skydotnet_v2/skysoft/",  "{skysoft}/", $list_html);
	$list_html = str_replace("/home/xuefer/htdocs/skydotnet_v2/matrix/",   "{matrix}/",  $list_html);
	$list_html = str_replace("/home/xuefer/htdocs/skydotnet_v2/tmp/ctpl/", "{ctpl}/",    $list_html);
	$list_html = str_replace("/home/xuefer/htdocs/skydotnet_v2/tmp/",      "{tmp}/",     $list_html);
	$list_html = str_replace("/home/xuefer/htdocs/skydotnet_v2/",          "{DOTNET}/",  $list_html);
