...
featurePopup.ini = function () {
    ...
    $('#feature-trigger').hover(function () {
        ...
        if (!featurePopup.disappearing) if (featurePopup.timer) clearTimeout(featurePopup.timer);
        ...
        var f = function () {
            ...
            function featureAnimate() {
                ...
                if (animationStep >= animationInterval) clearInterval(animationTimer);
    ...
    featurePopup.popup.hover(function () {
        if (!featurePopup.disappearing) {
            if (featurePopup.timer) clearTimeout(featurePopup.timer);
        }
    }, featurePopup.hide);
